...
The phase-by-phase record of how this was built: every experiment, every
control condition, every number as it was measured, and every mistake. The
[README](../README.md) is the summary; this is the evidence.

Phases are in build order: 1, 2, 4, 4.1, 4.2, 4.3, 3, 5, 6. Phases 1–5 were
measured against the mock with its original cost model (40ms prefill,
8ms/token, α = 0.08, queue depth 16); Phase 6 recalibrated those defaults
against an NVIDIA L4.
